(function (global) {
  ...
  var DICT = {
    pt: {
      ...
      dev_referral_commission: 'Comissão {pct}% (direta) = {value}',
      dev_points_total: 'Total agora: {value} pts',
      dev_payout_mode_fixed: 'Fixo {value}',
      tree_payout_lesser: 'Menor Perna',
      tree_payout_greater: 'Maior Perna',
      team_active_short: 'Ativos',
      tree_points_short: 'Pts',
    ...
    en: {
      ...
      dev_referral_commission: '{pct}% Commission (direct) = {value}',
      dev_points_total: 'Total now: {value} pts',
      dev_payout_mode_fixed: 'Fixed {value}',
      tree_payout_lesser: 'Lesser Leg',
      tree_payout_greater: 'Greater Leg',
      team_active_short: 'Active',
      tree_points_short: 'Pts',
    ...
    es: {
      ...
      dev_referral_commission: 'Comisión {pct}% (directa) = {value}',
      dev_points_total: 'Total ahora: {value} pts',
      dev_payout_mode_fixed: 'Fijo {value}',
      tree_payout_lesser: 'Pata Menor',
      tree_payout_greater: 'Pata Mayor',
      team_active_short: 'Activos',
      tree_points_short: 'Pts',
